...
from PyQt5.QtCore import QTimer, Qt, QLineF, QSize
...
b = 19  # b - количество ботов  19
c = 120  # интервал создания ботов в мс  80
v = 70  # v - количество шагов в секунду  70
s = 1  # s - длина шага в пикселях  2
...
class Form2(QtWidgets.QWidget):
    ...
    def show_track(self):
        ...
        if pause_resume_button[0] == True:
            if int(player_hp[0]) == 5 and game_result[3] == 19:
                pause_resume_button[0] = False
                self.weapons[3].setStyleSheet('font-size: 25px; color: green; background: black')
                self.weapons[3].setText(game_result[0])
            elif int(player_hp[0]) == 4 and game_result[3] == 18:
                pause_resume_button[0] = False
                self.weapons[3].setStyleSheet('font-size: 25px; color: green; background: black')
                self.weapons[3].setText(game_result[0])
            elif int(player_hp[0]) == 3 and game_result[3] == 17:
                pause_resume_button[0] = False
                self.weapons[3].setStyleSheet('font-size: 25px; color: green; background: black')
                self.weapons[3].setText(game_result[0])
            elif int(player_hp[0]) == 2 and game_result[3] == 16:
                pause_resume_button[0] = False
                self.weapons[3].setStyleSheet('font-size: 25px; color: green; background: black')
                self.weapons[3].setText(game_result[0])
            elif int(player_hp[0]) == 1 and game_result[3] == 15:
                pause_resume_button[0] = False
                self.weapons[3].setStyleSheet('font-size: 25px; color: green; background: black')
                self.weapons[3].setText(game_result[0])
    ...
    def bullet_moving(self):
        ...
        self.bullet_interval.timeout.connect(lambda: self.bullet_painting())
        self.bullet_interval.start(1000)

        self.bullet_painting()
