...
class Form2(QtWidgets.QWidget):
        ...
        if event.button() == Qt.LeftButton:
            ...
            if event.y() <= 720:
                if pause_resume_button[0] == True:
                    ...
                    target_coordinates[0] = (event.x())
                    target_coordinates[1] = (event.y())
    ...
    def zone_coverage(self):
        ...
        point_coordinates.append([point_x - 20, point_y - 20, point_x + 20, point_y + 20])
    ...
    def attack_damage(self):
        ...
        if pause_resume_button[0] == True:
            ...
            for j in range(number_of_bots):
                ...
                if point_coordinates[0][0] < (self.bots[j][0].x() + 20) and point_coordinates[0][1] \
                        < (self.bots[j][0].y() + 20) and point_coordinates[0][2] > (self.bots[j][0].x() + 20) \
                        and point_coordinates[0][3] > (self.bots[j][0].y() + 20):
                    self.bots[j][1] = self.bots[j][1] - ((5 * shot_count_tower[0]) + (5 * shot_count_tower[1]))
    ...
    def hit_on_target(self):
        ...
        self.bullet_interval.start(2000)
...
class Form3(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        text_label.setStyleSheet('font-size: 22px; color: white; background: black ')

        name_rule_label = QLabel(self)
        name_rule_label.move(170, 35)
        name_rule_label.resize(630, 30)

        name_rule_label.setWordWrap(True)
        name_rule_label.setText("Правила игры")
